...
const NFTDropPage = ({ collection }: Props) => {
  ...
  const minNft = () => {
    ...
    nftDrop
      ...
      .catch((err) => {
        console.log(err)
        toast('Whoops... Something went to wrong', {
          style: {
            background:'red',
            color: 'white',
            fontWeight: 'bolder',
    ...
    <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
      ...
      <div className="bg-gradient-to-br from-cyan-800 to-red-500 lg:col-span-4">
        <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
          <div className="rounded-2xl bg-gradient-to-br from-yellow-400 to-purple-600 p-1">
            <img
      ...
      <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        <header className="flex items-center justify-between">
          <Link href={'/'}>
            <h1 className="w-52 cursor-pointer text-xl font-extralight sm:w-80">
              The{' '}
              <span className="font-extrabold text-zinc-600 underline decoration-pink-600/50">
                {' '}
                Blingz
              </span>{' '}
              NFT Market Place
        ...
        <div className="flex flex-1 flex-col items-center space-y-6 text-center lg:justify-center lg:space-y-0">
          ...
          {loading ? (
            <p className="animate-bounce pt-2 text-xl text-green-600">
